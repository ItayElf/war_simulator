...
WAR_EVENT_TABLE: Dict[range, Event] = {
    ...
    range(-5, 10): BattleProgressEvent(),
    range(10, 15): NegativeEvent("Strategic disagreement"),
    range(15, 20): NegativeEvent("Public dissent grows"),
    range(20, 25): NegativeEvent("Religious tensions rise"),
    range(25, 30): NegativeEvent("Foreign sanctions imposed"),
    range(30, 35): NegativeEvent("Enemy infiltration succeeds"),
    range(35, 45): BattleStartEvent(),
    range(45, 60): BattleProgressEvent(),
    range(60, 65): BattleEndEvent(),
    range(65, 70): PositiveEvent("Foreign aid arrives"),
    range(70, 75): PositiveEvent("Cultural unity strengthens"),
    range(75, 80): PositiveEvent("Enemy official defects"),
    range(80, 85): PositiveEvent("New region joins the cause"),
    range(85, 100): BattleProgressEvent(),
    range(100, 105): PositiveEvent("Intelligence breakthrough"),
    range(105, 110): PositiveEvent("Public morale surges"),
